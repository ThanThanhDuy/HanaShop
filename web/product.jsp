	...
	<body>
		...
		<form action="MainController" class="row search-product" style="width: 1903px; display: flex; justify-content: center; margin-bottom: 30px;">
			...
			<div style="width: 133px;text-align: center; margin-left: 15px;">
				<input name="maxPrice" style="width: 135px; display: inline-block;" class="form-control " type="number" value="100000"
					   step="500">
				<p></p>
			</div>
			...
			<div>
				...
				<jsp:setProperty name="listCate" property="*"></jsp:setProperty>
					...
					<c:forEach items="${requestScope.LISTCATE}" var="listCate">
						<option value="${listCate.cateID}" selected>${listCate.cateName}</option>
					</c:forEach>
				</select>
			</div>
		...
		<div style="display: flex; justify-content: center;">
			...
			<div style="width: 1510px;display: flex;flex-wrap: wrap; justify-content: center;"
				...
				<c:forEach items="${requestScope.LISTPRODUCT}" var="listProdcut">
					<div class="products"
						 style="border: 1px solid #7dc129;border-radius: 10px ;max-width: 300px; margin: 10px;">
						<div style="text-align: center;">
							<img style="max-width: 300px;max-height: 200px;padding: 5px;"
								 src="${listProdcut.image}"
								 alt="">
							<a class="text-name-product" href="#"><p style="max-width: 250px;padding-left: 15px;padding-right: 10px;">${listProdcut.proName}</p></a>
						</div>
						<hr style="width: 80%;border-bottom: 2px solid #7dc129;">
						<p style="text-align: center">${listProdcut.price} VNĐ</p>
		...
		<nav aria-label="..." style="display: flex; justify-content: center; margin-top: 15px;">
			<ul class="pagination pagination-lg">
				<c:if test="${requestScope.INDEX>=2}">
					<c:forEach begin="1" end="${requestScope.INDEX}" var="count">
						<!--						<li class="page-item disabled">
													<a class="page-link" href="#" tabindex="-1">1</a>
												</li>-->
						<li class="page-item"><a class="page-link" href="MainController?btnAction=Search&minPrice=${requestScope.MINPRICE}&maxPrice=${requestScope.MAXPRICE}&cate=${requestScope.CATE}&txtSearch=${requestScope.TXTSEARCH}&index=${count}">${count}</a></li>
						</c:forEach>
					</c:if>
